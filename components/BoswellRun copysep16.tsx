      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {tab === "claude" && (
          <div className={`rounded-lg ${panel} p-6`}>
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-lg font-semibold">Step 4: Chapter Generation</h2>
            ...
            <textarea
              ...
              style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}
              rows={24}
              value={loadingClaude && !claudeOutput ? "Generating your chapter...\n\nThis may take a few minutes for a 7,000-word response." : claudeOutput}
              placeholder="Your generated chapter will stream here in real-time..."
            />
