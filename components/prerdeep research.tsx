...
const [voiceExemplar, setVoiceExemplar] = useState(`He was slow in learning how to talk. "My parents were so worried," he later recalled, "that they consulted a doctor." Even after he had begun using words, sometime after the age of two, he developed a quirk that prompted the family maid to dub him "der Depperte," the dopey one, and others in his family to label him as "almost backwards." Whenever he had something to say, he would try it out on himself, whispering it softly until it sounded good enough to pronounce aloud. "Every sentence he uttered," his worshipful younger sister recalled, "no matter how routine, he repeated to himself softly, moving his lips." It was all very worrying, she said. "He had such difficulty with language that those around him feared he would never learn." This initial struggle with language is immediately contextualized as an unusual trait for the future genius, underscoring the contrast between his early "backward" appearance and his later extraordinary mental visualization skills.`);
...
const tutorialSteps = [
  ...
  },
  {
    ...
    fields: ["final"],
    canProceed: () => nbOut1.trim().length > 0 && nbOut2.trim().length > 0
  }
];
...
4) Relevant Context for this Chapter:
 - Extract background information from your sources about key concepts, technologies, historical events, or industry developments that are important for understanding this chapter's events and decisions
...
1) Expanded report for each chronological turning point (matching Step 2A numbering).
 ...
 - Sub-bullets with ALL relevant quotes and scenes.
 ...
 - Key scenes if identifiable (include characters, setting, and source).
...
6) LENGTH REQUIREMENT
 - Generate 18,000-22,000 tokens of polished narrative content.
 - This should produce approximately 7,000-8,000 words of final text.
 - Continue generating substantial content until you reach at least 18,000 tokens.
 - If approaching the endpoint before 18,000 tokens, deepen scenes/quotes/analysis before concluding.
...
const assembledAiPrompt = useMemo(() => {
  ...
  parts.push(`\nFINAL INSTRUCTION\n- You MUST generate 18,000-22,000 tokens of output to achieve approximately 7,000-8,000 words. Do not stop generating until you have produced at least 18,000 tokens of substantial narrative content. Continue expanding scenes, adding detail, and developing the narrative until you reach this minimum token count.`);
  return parts.join("\n\n");
}, [aiSystemHeader, voiceGuide, voiceExemplar, nbOut1, nbOut2]);
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className={`text-sm ${muted} leading-relaxed`}>
                    Once both NotebookLM outputs are integrated, initiate the generation of a complete ~7,000-word biographical chapter in Walter Isaacson's distinguished literary style using your selected AI model.
                  </p>
                </div>
              </div>
            </div>
