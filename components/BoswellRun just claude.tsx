...
- NEVER extend beyond what the chapter name specifies to fill remaining words
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg border-2 text-sm font-medium transition-all duration-300 hover:scale-105"
            style={{
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-40 flex items-center justify-center p-6">
          <div className={`max-w-2xl w-full rounded-xl ${panel} p-8 relative`}>
            ...
            <div className="mb-8">
              ...
              {tutorialStep === 2 && (
                <div>
                  <div className="mb-6 p-6 rounded-lg border-2 border-amber-200 bg-amber-50">
                    <h4 className="text-base font-bold mb-3" style={{ color: BRAND_COLOR, fontFamily: 'Playfair Display, Georgia, serif' }}>
                    ...
                    <ol className="text-sm space-y-2 list-decimal list-inside text-stone-700">
                      ...
                      <li>Open your NotebookLM project that contains your research materials for this chapter</li>
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      readOnly
                      className={`w-full p-3 rounded-lg ${input} text-sm mb-3`}
                      rows={6}
                      value={nbPrompt1}
                    />
                    <button 
            ...
            <div className="flex items-center justify-between">
              ...
              {tutorialStep < totalTutorialSteps ? (
                <button
                  ...
                  className={`px-6 py-2 rounded-lg text-sm font-medium transition-all text-white border-2 ${
